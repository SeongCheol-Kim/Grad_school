...
hidden_layer = Dense(15, activation='relu')(input_data)
hidden_layer = Dense(10, activation='relu')(hidden_layer)
dropout = Dropout(rate=0.3)(hidden_layer)
output_layer = Dense(1, activation=None)(dropout)
...
####Evaluate Results####
test_loss, test_rmse = model.evaluate(x=data_test, y=target_test, verbose=0)                                                 
print('\nRMSE:', test_rmse)
...
#
# acc_ax.plot(results.history['root_mean_squared_error'], 'b', label='train rmse')
